 ...
 ************************************************************
 ...
 Number used before BFC allowance is                         102800
 Number used after BFC allowance is                          102800
 biggest cell volume divided by average is     1.96153615362194       at:
 ix = 1 iy = 26 iz = 61
 xg =0.26 yg =0.073558 zg =1.5125
 smallest cell volume divided by average is   3.846115692304598E-002  at:
 ix = 1 iy = 1 iz = 62
 xg =0.26 yg =1.442308E-03 zg =1.5375
 ratio of smallest to biggest is   1.960767169752555E-002
 ************************************************************
 ...
 ************************************************************
 ...
 PATCH(OB2 ,HIGH , 1, 1, 1, 26, 100, 100, 1, 1)
 COVAL(OB2 ,P1 ,1000. ,0. )
 COVAL(OB2 ,V1 ,0. ,0. )
 COVAL(OB2 ,W1 ,0. ,0. )
 
   Parent VR object for this patch is: PLAT3         
 PATCH(OB3 ,NWALL , 1, 1, 26, 26, 1, 100, 1, 1)
 COVAL(OB3 ,W1 ,1. ,0. )
 XCYCLE = F
 EGWF = F
 ************************************************************
 ...
 *** grid-geometry information ***
 ...
 Total number of F-array elements used is                    103141
 --- INTEGRATION OF EQUATIONS BEGINS ---
 
 ************************************************************
 Run ending on sweep   964 with all residuals below RESFAC ( 1.000000E-05)
 ************************************************************
 *** End of sweep 965
 ************************************************************
 
 ************************************************************
 Whole-field residuals before solution at sweep 965
 with resref values determined by EARTH
 & resfac=1.0E-05
  variable   resref  (res sum)/resref  (res sum)
     P1     1.281E+00   9.858E-10      1.263E-09
     V1     1.851E+00   1.340E-06      2.482E-06
     W1     1.851E+00   9.456E-06      1.750E-05
 
 max abs corrections for solved-for variables
 for comparison with maximum & minimum values
  variable   max-cor      high           low     (   IX    IY    IZ)
     P1     2.359E-04   6.420E+02      5.605E-02 (    1,    9,   75)
     V1     1.549E-07   3.131E-03     -5.959E-02 (    1,   10,  100)
     W1     3.198E-06   8.967E-01      3.462E-02 (    1,    1,   99)
 ...
 ************************************************************
 ...
 Nett source of V1   at patch named: OB2      (OUTL2       ) =-7.235514E-04
 pos. sum=0. neg. sum=-7.235514E-04
 nett sum=-7.235514E-04
 
 Nett source of W1   at patch named: OB1      (INLE1       ) = 2.695009E-01
 Nett source of W1   at patch named: OB2      (OUTL2       ) =-3.570753E-01
 Nett source of W1   at patch named: OB3      (PLAT3       ) =-8.297271E-01
 pos. sum=0.269501 neg. sum=-1.186802
 nett sum=-0.917301
 ...
 nett sum=5.218048E-15
 
 
 ************************************************************
 Summary of sources from all Objects/Patches at sweep   965
    Variable      Inflow        Outflow       Nett
       P1       5.988909E-01 -5.988909E-01  5.218048E-15
       V1       0.000000E+00 -7.235514E-04 -7.235514E-04
       W1       2.695009E-01 -1.186802E+00 -9.173015E-01
 ************************************************************
 
 
 ************************************************************
 spot values vs sweep or iteration number
 IXMON= 1 IYMON= 26 IZMON= 86 TIMESTEP= 1
 
 Tabulation of abscissa and ordinates...
   ISWP       P1           V1           W1  
      1   0.0000E+00   0.0000E+00   1.0000E-10
    501   7.2374E+01   0.0000E+00   3.5135E-02
   Variable    1 = P1     2 = V1     3 = W1  
     Minval=  0.000E+00  0.000E+00  1.000E-10
     Maxval=  7.237E+01  0.000E+00  3.513E-02
     Cellav=  3.619E+01  0.000E+00  1.757E-02
 1.00 +....+....+....+....+....+....+....+....+....+....3
      .                                                 .
 0.90 +                                                 +
      .                                                 .
 ...
 ************************************************************
 ...
 Tabulation of abscissa and ordinates...
   ISWP       P1           V1           W1  
    ...
    501   6.9026E-08   9.6780E-05   6.0343E-03
   Variable    1 = P1     2 = V1     3 = W1  
     Minval= -1.649E+01 -2.234E+01 -5.110E+00
     Maxval=  9.531E-02 -9.243E+00 -1.626E+00
 1.00 3....+....+....+....+....+....+....+....+....+....2
      .                                                 .
 0.90 +                                                 +
      .                                                 .
 ...
 ************************************************************
 ...
 Run started at 11:57:12 on Sunday, 24 November 2024                           
 Run completed at 11:57:26 on Sunday, 24 November 2024                         
 CPU time of run 19 s
 This includes 19 seconds of user time and 0 seconds of system time.
 TIME/(VARIABLES*CELLS*TSTEPS*SWEEPS*ITS) = 2.524E-06
 ************************************************************
