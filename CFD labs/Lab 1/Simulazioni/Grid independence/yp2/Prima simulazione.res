 ...
 ************************************************************
 ...
 Number used before BFC allowance is                         118212
 Number used after BFC allowance is                          118212
 biggest cell volume divided by average is     1.41617782525665       at:
 ix = 1 iy = 19 iz = 61
 xg =0.26 yg =0.057187 zg =1.5125
 smallest cell volume divided by average is   7.374735085762445E-002  at:
 ix = 1 iy = 1 iz = 62
 xg =0.26 yg =1.859285E-03 zg =1.5375
 ratio of smallest to biggest is   5.207492275502870E-002
 ************************************************************
 ...
 ************************************************************
 ...
 NY = 30
 YVLAST =0.075
 YFRAC(1)=0.049581 ;YFRAC(7)=0.32871
 YFRAC(13)=0.573429 ;YFRAC(19)=0.777972
 YFRAC(25)=0.931959
 ************************************************************
 ...
 ************************************************************
 ...
 PATCH(OB2 ,HIGH , 1, 1, 1, 30, 100, 100, 1, 1)
 COVAL(OB2 ,P1 ,1000. ,0. )
 COVAL(OB2 ,V1 ,0. ,0. )
 COVAL(OB2 ,W1 ,0. ,0. )
 
   Parent VR object for this patch is: PLAT3         
 PATCH(OB3 ,NWALL , 1, 1, 30, 30, 1, 100, 1, 1)
 COVAL(OB3 ,W1 ,1. ,0. )
 XCYCLE = F
 EGWF = F
 ************************************************************
 ...
 *** grid-geometry information ***
 ...
 Y-coordinates of the cell centres
    1.859E-03   2.299E-02   4.158E-02   5.719E-02   6.909E-02
 ...
 Y-coordinates of the (higher) cell faces
    3.719E-03   2.465E-02   4.301E-02   5.835E-02   6.990E-02

 Z-coordinates of the (higher) cell faces
    2.500E-02   5.250E-01   1.025E+00   1.525E+00   2.025E+00

 
 Total number of F-array elements used is                    118573
 --- INTEGRATION OF EQUATIONS BEGINS ---
 
 ************************************************************
 Run ending on sweep   896 with all residuals below RESFAC ( 1.000000E-05)
 ************************************************************
 *** End of sweep 897
 ************************************************************
 
 ************************************************************
 Whole-field residuals before solution at sweep 897
 with resref values determined by EARTH
 & resfac=1.0E-05
  variable   resref  (res sum)/resref  (res sum)
     P1     1.282E+00   3.012E-10      3.862E-10
     V1     1.963E+00   7.525E-07      1.477E-06
     W1     1.963E+00   9.643E-06      1.893E-05
 
 max abs corrections for solved-for variables
 for comparison with maximum & minimum values
  variable   max-cor      high           low     (   IX    IY    IZ)
     P1     2.042E-04   6.479E+02      2.365E-02 (    1,   16,   75)
     V1     4.832E-08   2.365E-03     -6.282E-02 (    1,   10,  100)
     W1     4.012E-07   8.970E-01      5.481E-03 (    1,    6,   99)
 ...
 ************************************************************
 ...
 Nett source of V1   at patch named: OB2      (OUTL2       ) =-6.595632E-04
 pos. sum=0. neg. sum=-6.595632E-04
 nett sum=-6.595632E-04
 
 Nett source of W1   at patch named: OB1      (INLE1       ) = 2.695009E-01
 Nett source of W1   at patch named: OB2      (OUTL2       ) =-3.576020E-01
 Nett source of W1   at patch named: OB3      (PLAT3       ) =-8.314911E-01
 pos. sum=0.269501 neg. sum=-1.189093
 nett sum=-0.919592
 ...
 nett sum=4.662937E-15
 
 
 ************************************************************
 Summary of sources from all Objects/Patches at sweep   897
    Variable      Inflow        Outflow       Nett
       P1       5.988909E-01 -5.988909E-01  4.662937E-15
       V1       0.000000E+00 -6.595632E-04 -6.595632E-04
       W1       2.695009E-01 -1.189093E+00 -9.195922E-01
 ************************************************************
 
 
 ************************************************************
 spot values vs sweep or iteration number
 IXMON= 1 IYMON= 29 IZMON= 86 TIMESTEP= 1
 
 Tabulation of abscissa and ordinates...
   ISWP       P1           V1           W1  
      1   0.0000E+00   9.9995E-11   1.0000E-10
    501   7.1377E+01  -1.5179E-09   2.1024E-02
   Variable    1 = P1     2 = V1     3 = W1  
     Minval=  0.000E+00 -1.518E-09  1.000E-10
     Maxval=  7.138E+01  1.000E-10  2.102E-02
     Cellav=  3.569E+01 -7.090E-10  1.051E-02
 1.00 2....+....+....+....+....+....+....+....+....+....3
      .                                                 .
 0.90 +                                                 +
      .                                                 .
 ...
 ************************************************************
 ...
 Tabulation of abscissa and ordinates...
   ISWP       P1           V1           W1  
      1   1.1000E+00   1.8844E-10   1.9679E-01
    501   2.6398E-08   4.7916E-05   2.0647E-03
   Variable    1 = P1     2 = V1     3 = W1  
     Minval= -1.745E+01 -2.239E+01 -6.183E+00
     Maxval=  9.531E-02 -9.946E+00 -1.626E+00
 1.00 3....+....+....+....+....+....+....+....+....+....2
      .                                                 .
 0.90 +                                                 +
      .                                                 .
 ...
 ************************************************************
 ...
 Run started at 15:32:44 on Tuesday, 26 November 2024                          
 Run completed at 15:32:51 on Tuesday, 26 November 2024                        
 CPU time of run 8 s
 This includes 8 seconds of user time and 0 seconds of system time.
 TIME/(VARIABLES*CELLS*TSTEPS*SWEEPS*ITS) = 9.910E-07
 ************************************************************
