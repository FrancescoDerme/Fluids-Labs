 ...
 ************************************************************
 ...
 biggest cell volume divided by average is     1.98001979999999       at:
 ix = 1 iy = 50 iz = 61
 xg =0.26 yg =0.396 zg =1.5125
 smallest cell volume divided by average is   1.999979999999968E-002  at:
 ix = 1 iy = 1 iz = 62
 xg =0.26 yg =4.0E-03 zg =1.5375
 ...
 *** grid-geometry information ***
 ...
 Y-coordinates of the cell centres
    4.000E-03   8.400E-02   1.640E-01   2.440E-01   3.240E-01
 ...
 Y-coordinates of the (higher) cell faces
    8.000E-03   8.800E-02   1.680E-01   2.480E-01   3.280E-01
 ...
 ************************************************************
 Run ending on sweep   677 with all residuals below RESFAC ( 1.000000E-05)
 ************************************************************
 *** End of sweep 678
 ************************************************************
 
 ************************************************************
 Whole-field residuals before solution at sweep 678
 with resref values determined by EARTH
 & resfac=1.0E-05
  variable   resref  (res sum)/resref  (res sum)
     P1     5.470E+01   1.042E-09      5.700E-08
     V1     4.776E+01   3.972E-06      1.897E-04
     W1     4.776E+01   9.332E-06      4.457E-04
 
 max abs corrections for solved-for variables
 for comparison with maximum & minimum values
  variable   max-cor      high           low     (   IX    IY    IZ)
     P1     2.073E-04   2.036E+02      5.357E-02 (    1,    1,   37)
     V1     6.466E-07   2.249E-03     -5.749E-02 (    1,   33,  100)
     W1     1.895E-06   8.810E-01      5.149E-02 (    1,   43,   99)
 ...
 ************************************************************
 ...
 Nett source of V1   at patch named: OB2      (OUTL2       ) = 7.232018E-02
 pos. sum=0.07232 neg. sum=0.
 nett sum=0.07232
 
 Nett source of W1   at patch named: OB1      (INLE1       ) = 1.854934E+01
 Nett source of W1   at patch named: OB2      (OUTL2       ) =-2.095431E+01
 Nett source of W1   at patch named: OB3      (PLAT3       ) =-3.466943E+00
 pos. sum=18.549345 neg. sum=-24.421248
 nett sum=-5.871903
 
 Nett source of R1   at patch named: OB1      (INLE1       ) = 2.649906E+01
 Nett source of R1   at patch named: OB2      (OUTL2       ) =-2.649906E+01 (Mass Out -2.649906E+01 In 0.000000E+00)
 pos. sum=26.499064 neg. sum=-26.499064
 nett sum=1.065814E-14
 
 
 ************************************************************
 Summary of sources from all Objects/Patches at sweep   678
    Variable      Inflow        Outflow       Nett
       P1       2.649906E+01 -2.649906E+01  1.065814E-14
       V1       7.232018E-02  0.000000E+00  7.232018E-02
       W1       1.854934E+01 -2.442125E+01 -5.871903E+00
 ************************************************************
 
 
 ************************************************************
 spot values vs sweep or iteration number
 IXMON= 1 IYMON= 10 IZMON= 85 TIMESTEP= 1
 
 Tabulation of abscissa and ordinates...
   ISWP       P1           V1           W1  
      1   0.0000E+00   9.9912E-11   1.0000E-10
    501   1.1775E+01  -1.5736E-03   8.4978E-01
   Variable    1 = P1     2 = V1     3 = W1  
     Minval=  0.000E+00 -1.574E-03  1.000E-10
     Maxval=  1.178E+01  9.991E-11  8.498E-01
     Cellav=  5.888E+00 -7.868E-04  4.249E-01
 1.00 2....+....+....+....+....+....+....+....+....+....3
      .                                                 .
 0.90 +                                                 +
      .                                                 .
 ...
 ************************************************************
 ...
 Tabulation of abscissa and ordinates...
   ISWP       P1           V1           W1  
      1   1.1000E+00   2.5776E-09   9.4402E-01
    501   1.0785E-07   3.9812E-04   1.0461E-03
   Variable    1 = P1     2 = V1     3 = W1  
     Minval= -1.604E+01 -1.978E+01 -6.863E+00
     Maxval=  9.531E-02 -7.829E+00 -5.761E-02
 1.00 3....+....+....+....+....+....+....+....+....+....2
      .                                                 .
 0.90 +                                                 +
      .                                                 .
 ...
 ************************************************************
 ...
 Run started at 18:32:29 on Tuesday, 26 November 2024                          
 Run completed at 18:32:36 on Tuesday, 26 November 2024                        
 CPU time of run 8 s
 This includes 8 seconds of user time and 0 seconds of system time.
 TIME/(VARIABLES*CELLS*TSTEPS*SWEEPS*ITS) = 7.866E-07
 ************************************************************
