...
directoryLoad = "C:\Users\user\Desktop\CFD labs\Lab 1\Simulazioni\Friction factor\3\Prima simulazione.phi";
directorySave = "C:\Users\user\Desktop\CFD labs\Lab 1\Matlab\3.mat";

% INSERT YES IF THE CASE IS BODY FITTED (IS THE GRID IS CARTESIAN LEAVE NO)
BFC='no';
...
% to process all the variables write 'all' (pay attention to time required)
