...
directoryLoad = "C:\Users\user\Desktop\CFD labs\Lab 2\Simulazioni\low-Re approach\ref5\Prima simulazione.phi";
directorySave = "C:\Users\user\Desktop\CFD labs\Lab 2\Matlab\ref5lowre.mat";

% INSERT YES IF THE CASE IS BODY FITTED (IS THE GRID IS CARTESIAN LEFT NO)
BFC='no';
...
% variables={'P1' 'V1' 'W1'}; %to let process all the variables write 'all' (pay attention to time required)
variables={'all'};
% The script "1" to highlight the first phase fluid
